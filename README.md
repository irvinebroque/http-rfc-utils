...
| DPoP proof JWT and header helpers | `parseDpopHeader`, `formatDpopHeader`, `parseDpopAuthorization`, `formatDpopAuthorization`, `parseDpopChallenge`, `formatDpopChallenge`, `parseDpopProofJwt`, `formatDpopProofJwt`, `validateDpopProofJwt`, `computeDpopAth`, `parseDpopNonce`, `formatDpopNonce`, `validateDpopNonce` |
...
- Auth and transport security: RFC 7617, RFC 6750, RFC 7616, RFC 7636, RFC 9449, RFC 8414, RFC 6797, RFC 8470, RFC 7838, RFC 9053, RFC 9421, RFC 9309, RFC 9116, RFC 7239.
