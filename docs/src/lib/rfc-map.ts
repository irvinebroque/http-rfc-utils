...
export const RFC_MAP: RfcMapEntry[] = [
    ...
    {
        module: 'src/oauth-client-registration.ts',
        rfc: 'RFC 7591',
        sections: ['2', '2.1', '2.2', '2.3', '3.1', '3.1.1', '3.2', '3.2.1', '3.2.2'],
        exports: [
        ...
        notes: 'Dynamic client registration request/response/error JSON helpers with strict metadata validation, grant/response consistency enforcement, and software-statement claim precedence merge without JWT verification.',
    },
    {
        module: 'src/oauth-client-registration-management.ts',
        rfc: 'RFC 7592',
        sections: ['2', '2.1', '2.2', '2.3', '3'],
        exports: [
        ...
        notes: 'Dynamic client registration management helpers for client information responses and configuration update requests, enforcing required registration access token/client URI fields and update-request field exclusions.',
    },
    {
