...
export const RFC_MAP: RfcMapEntry[] = [
    ...
    {
        module: 'src/auth/jwt-access-token.ts',
        rfc: 'RFC 9068',
        sections: ['2', '2.1', '2.2', '2.2.1', '2.2.3', '4'],
        exports: [
            'parseJwtAccessToken',
        ...
        notes: 'JWT access token profile helpers for header/claim validation, tolerant parsing, and deterministic JSON formatting; signature verification and encryption are out of scope.',
    },
    {
