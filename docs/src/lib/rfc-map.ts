...
export const RFC_MAP: RfcMapEntry[] = [
    ...
    },
    {
        ...
        notes: 'Authorization server metadata parse/validate/format helpers with RFC 8414 well-known URL derivation, exact issuer comparison options, and signed-claims precedence merge support without JOSE verification. Includes RFC 9126 PAR metadata fields.',
    },
    {
        module: 'src/oauth-par.ts',
        rfc: 'RFC 9126',
        ...
        notes: 'PAR request/response helpers for x-www-form-urlencoded pushed authorization requests and JSON success/error responses with deterministic parsing and strict validation; OAuth service orchestration remains out of scope.',
    },
    {
