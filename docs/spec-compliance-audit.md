...
Status: canonical spec-compliance status document for the 2026-02-11 remediation cycle.
Supersession note: `docs/spec-compliance-audit-deep-pass-2026-02-11.md` is a point-in-time deep-pass snapshot and is not the final status tracker.
