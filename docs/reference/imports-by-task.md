...
| OAuth authorization response issuer identification (RFC 9207) | `parseAuthorizationResponseIssuerParam`, `formatAuthorizationResponseIssuerParam`, `validateAuthorizationResponseIssuer` |
