...
| DPoP proof JWT and header helpers (RFC 9449) | `parseDpopHeader`, `formatDpopHeader`, `parseDpopAuthorization`, `formatDpopAuthorization`, `parseDpopChallenge`, `formatDpopChallenge`, `parseDpopProofJwt`, `formatDpopProofJwt`, `validateDpopProofJwt`, `computeDpopAth`, `parseDpopNonce`, `formatDpopNonce`, `validateDpopNonce` |
